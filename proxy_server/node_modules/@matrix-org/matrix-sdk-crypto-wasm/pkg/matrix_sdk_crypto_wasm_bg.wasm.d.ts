...
export const rehydrateddevice_receiveEvents: (a: number, b: number, c: number) => any;
...
export const device_encryptToDeviceEvent: (a: number, b: number, c: number, d: any) => any;
...
export const migration_migrateBaseData: (a: number, b: any, c: number) => any;
...
export const migration_migrateOlmSessions: (a: number, b: number, c: any, d: number) => any;
...
export const migration_migrateMegolmSessions: (a: number, b: number, c: any, d: number) => any;
export const __wbg_olmmachine_free: (a: number, b: number) => void;
export const olmmachine_new: () => [number, number, number];
export const olmmachine_initialize: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
export const olmmachine_initFromStore: (a: number, b: number, c: number) => any;
...
export const olmmachine_receiveSyncChanges: (a: number, b: number, c: number, d: number, e: any, f: number) => [number, number, number];
...
export const olmmachine_registerRoomKeyUpdatedCallback: (a: number, b: any) => any;
export const olmmachine_registerRoomKeysWithheldCallback: (a: number, b: any) => any;
export const olmmachine_registerUserIdentityUpdatedCallback: (a: number, b: any) => any;
export const olmmachine_registerDevicesUpdatedCallback: (a: number, b: any) => any;
export const olmmachine_registerReceiveSecretCallback: (a: number, b: any) => any;
...
export const decryptedroomevent_senderCurve25519Key: (a: number) => any;
...
export const encryptioninfo_sender: (a: number) => number;
export const encryptioninfo_senderDevice: (a: number) => number;
export const encryptioninfo_senderCurve25519Key: (a: number) => any;
export const encryptioninfo_senderClaimedEd25519Key: (a: number) => any;
...
export const storehandle_open: (a: number, b: number, c: number, d: number) => any;
export const storehandle_openWithKey: (a: number, b: number, c: number, d: number) => any;
...
export const closure43_externref_shim_multivalue_shim: (a: number, b: number, c: any) => [number, number];
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0def4b7acf9443a4: (a: number, b: number) => void;
export const closure740_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1d83a6fb10cd0388: (a: number, b: number) => void;
export const closure427_externref_shim: (a: number, b: number, c: any) => void;
export const closure439_externref_shim: (a: number, b: number, c: any, d: any) => void;
