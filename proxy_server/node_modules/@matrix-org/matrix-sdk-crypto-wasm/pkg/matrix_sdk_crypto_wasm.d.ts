...
export class Migration {
   ...
   *   store the vodozemac data.
   */
  static migrateOlmSessions(sessions: PickledSession[], pickle_key: Uint8Array, store_handle: StoreHandle): Promise<any>;
  /**
   ...
   *   store the vodozemac data.
   */
  static migrateMegolmSessions(sessions: PickledInboundGroupSession[], pickle_key: Uint8Array, store_handle: StoreHandle): Promise<any>;
}
/**
...
export class OlmMachine {
   ...
   */
  static initialize(user_id: UserId, device_id: DeviceId, store_name?: string | null, store_passphrase?: string | null): Promise<any>;
  /**
   ...
   *   this machine.
   */
  static initFromStore(user_id: UserId, device_id: DeviceId, store_handle: StoreHandle): Promise<any>;
  /**
   ...
   */
  receiveSyncChanges(to_device_events: string, changed_devices: DeviceLists, one_time_keys_counts: Map<any, any>, unused_fallback_keys?: Set<any> | null): Promise<any>;
  /**
   ...
   */
  exportSecretsBundle(): Promise<SecretsBundle>;
  /**
...
export class RehydratedDevice {
   ...
   * received.
   */
  receiveEvents(to_device_events: string): Promise<Array<any>>;
}
/**
 * A Matrix [room ID].
 *
...
export class StoreHandle {
   ...
   */
  static open(store_name?: string | null, store_passphrase?: string | null): Promise<StoreHandle>;
  /**
   ...
   */
  static openWithKey(store_name: string, store_key: Uint8Array): Promise<StoreHandle>;
}
/**
