 ...
 */
export declare function globToRegexp(glob: string): string;
 ...
 */
export declare function logDuration<T>(logger: BaseLogger, name: string, block: () => Promise<T>): Promise<T>;
/**
 ...
 * @param block - The block to execute.
 */
export declare function logDurationSync<T>(logger: BaseLogger, name: string, block: () => T): T;
/**
 ...
 */
export declare function recursiveMapToObject(map: Map<any, any>): Record<any, any>;
