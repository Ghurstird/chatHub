...
export class LegacyMembershipManager {
  ...
  get membershipServerSideExpiryTimeout() {
    var _ref, _this$membershipServe, _this$joinConfig3;
    return (_ref = (_this$membershipServe = this.membershipServerSideExpiryTimeoutOverride) !== null && _this$membershipServe !== void 0 ? _this$membershipServe : (_this$joinConfig3 = this.joinConfig) === null || _this$joinConfig3 === void 0 ? void 0 : _this$joinConfig3.membershipServerSideExpiryTimeout) !== null && _ref !== void 0 ? _ref : 8000;
  }
  get membershipKeepAlivePeriod() {
    var _this$joinConfig$memb2, _this$joinConfig4;
    return (_this$joinConfig$memb2 = (_this$joinConfig4 = this.joinConfig) === null || _this$joinConfig4 === void 0 ? void 0 : _this$joinConfig4.membershipKeepAlivePeriod) !== null && _this$joinConfig$memb2 !== void 0 ? _this$joinConfig$memb2 : 5000;
  }
  get callMemberEventRetryJitter() {
    var _this$joinConfig$call2, _this$joinConfig5;
    return (_this$joinConfig$call2 = (_this$joinConfig5 = this.joinConfig) === null || _this$joinConfig5 === void 0 ? void 0 : _this$joinConfig5.callMemberEventRetryJitter) !== null && _this$joinConfig$call2 !== void 0 ? _this$joinConfig$call2 : 2000;
  }
