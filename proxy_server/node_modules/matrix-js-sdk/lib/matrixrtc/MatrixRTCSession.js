  ...
  constructor(client, roomSubset, memberships) {
    ...
    _defineProperty(this, "recalculateSessionMembers", () => {
      ...
      if (changed) {
        ...
        this.logger.info("Memberships for call in room ".concat(this.roomSubset.roomId, " have changed: emitting"));
