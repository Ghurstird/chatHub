...
export class RoomWidgetClient extends MatrixClient {
      ...
      var _ref2 = _asyncToGenerator(function* (ev) {
        ...
        if (ev.detail.data.room_id === _this.roomId) {
          ...
          if (_this.syncApi instanceof SyncApi) {
            ...
            // }
            // ```
            yield _this.syncApi.injectRoomEvents(_this.room, [], [_event]); // Sliding Sync
          }
  ...
  encryptAndSendToDevice(eventType, devices, payload) {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this8.widgetApi.sendToDevice(eventType, true, recursiveMapToObject(contentMap)).catch(timeoutToConnectionError);
    })();
  }
  sendToDevice(eventType, contentMap) {
    var _this9 = this;
    return _asyncToGenerator(function* () {
      yield _this9.widgetApi.sendToDevice(eventType, false, recursiveMapToObject(contentMap)).catch(timeoutToConnectionError);
      return {};
    })();
  }
  getOpenIdToken() {
    var _this10 = this;
    return _asyncToGenerator(function* () {
      var token = yield _this10.widgetApi.requestOpenIDConnectToken().catch(timeoutToConnectionError);
  ...
  watchTurnServers() {
    var _this15 = this;
    return _asyncToGenerator(function* () {
      var servers = _this15.widgetApi.getTurnServers();
      var onClientStopped = () => {
