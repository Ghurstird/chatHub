  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{width: "100%"}}>
        <TextInput placeholder='Kullanıcı Adı' placeholderTextColor='#888' style={styles.input} onChangeText={setUsername} color={'#000'} />
        <TextInput placeholder="Şifre" placeholderTextColor='#888' style={styles.input} secureTextEntry onChangeText={setPassword} color={'#000'} />
        {loading ? (
